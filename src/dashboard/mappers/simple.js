...
export const cypherResultToXYChartData = (cypherResult, existingData, tick, props) => {
  const data = cypherResult ? [...existingData, ...responseHandler(cypherResult, tick, props)] : existingData
  return applyDataLimit(data)

}
export const cypherResultToCircularChartData = (cypherResult, existingData, props) => {
  const data = cypherResult ? [...responsePieHandler(cypherResult, props)] : existingData
